...
DROP DATABASE IF EXISTS `npcore`;
...
-- Dumping data for table npcore.characters: ~1 rows (approximately)
/*!40000 ALTER TABLE `characters` DISABLE KEYS */;
REPLACE INTO `characters` (`id`, `owner`, `first_name`, `last_name`, `date_created`, `dob`, `cash`, `bank`, `phone_number`, `story`, `new`, `deleted`, `gender`, `jail_time`, `stress_level`, `metaData`, `bones`, `emotes`, `paycheck`, `meta`) VALUES
	(1, 'steam:1100001137bf86c', 'Toon', 'Toon', '2021-07-03 02:27:37', '1995-10-31', 5000000, 5000000, '8835449218', 'Default story - new char system', 1, 0, 0, 0, 0, '{"health":148,"hunger":92,"thirst":95,"armour":0}', '{}', '{}', 0, 'move_m@casual@d');
...
-- Dumping data for table npcore.character_face: ~1 rows (approximately)
/*!40000 ALTER TABLE `character_face` DISABLE KEYS */;
REPLACE INTO `character_face` (`cid`, `hairColor`, `headBlend`, `headOverlay`, `headStructure`) VALUES
...
REPLACE INTO `delivery_job` (`id`, `active`, `jobType`, `dropAmount`, `pickup`, `drop`) VALUES
...
REPLACE INTO `fine_types` (`id`, `label`, `amount`, `jailtime`, `category`) VALUES
...
REPLACE INTO `group_banking` (`group_type`, `bank`) VALUES
	('burger_shot', 0),
	('police', 0),
	('ems', 0),
	('car_shop', 0),
...
-- Dumping data for table npcore.logs: ~1 rows (approximately)
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
REPLACE INTO `logs` (`type`, `log`, `data`, `cid`, `steam_id`) VALUES
	('Job Pay', 'User recieved paycheck, amount: 10', 'None', 0, 'STEAM_0:0:163445814');
...
REPLACE INTO `mech_materials` (`Shop`, `rubber`, `aluminium`, `scrapmetal`, `plastic`, `copper`, `steel`, `glass`) VALUES
...
-- Dumping data for table npcore.playerstattoos: ~1 rows (approximately)
...
-- Dumping data for table npcore.users: ~1 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
REPLACE INTO `users` (`id`, `hex_id`, `steam_id`, `community_id`, `license`, `name`, `ip`, `rank`, `date_created`, `controls`, `settings`, `inventory_settings`) VALUES
	(1, 'steam:1100001137bf86c', 'STEAM_0:0:163445814', '76561198287157360', 'license:cd554f5a4ad83397593d282bc0d068f0c1c87034', 'FiveSixZ', 'Uknown', 'police', '2021-07-03 01:34:27', '{"helilockon":"SPACE","helivision":"INPUTAIM","carStereo":"LEFTALT+P","generalProp":"7","generalUseThird":"G","radiotoggle":",","vehicleDoors":"L","showDispatchLog":"z","housingSecondary":"G","helispotlight":"G","tokoptt":"CAPS","vehicleBelt":"B","newsNormal":"E","heliCam":"E","devmarker":"F6","newsTools":"H","devnoclip":"F2","distanceChange":"G","devmenu":"F5","tokoToggle":"LEFTCTRL","radiovolumedown":"[","generalUse":"E","generalTackle":"LEFTALT","vehicleHotwire":"H","radiovolumeup":"]","loudSpeaker":"-","vehicleSsound":"LEFTALT","handheld":"LEFTSHIFT+P","helirappel":"X","vehicleCruise":"X","movementCrouch":"X","newsMovie":"M","generalChat":"T","generalInventory":"K","generalUseSecondaryWorld":"F","generalPhone":"P","generalUseSecondary":"ENTER","vehicleSearch":"G","generalEscapeMenu":"ESC","actionBar":"TAB","switchRadioEmergency":"9","housingMain":"H","generalScoreboard":"U","movementCrawl":"Z","vehicleSnavigate":"R","generalMenu":"F1","vehicleSlights":"Q","devcloak":"F3"}', '{}', NULL);
...
-- Dumping data for table npcore.user_inventory2: ~7 rows (approximately)
/*!40000 ALTER TABLE `user_inventory2` DISABLE KEYS */;
REPLACE INTO `user_inventory2` (`id`, `name`, `item_id`, `quality`, `information`, `slot`, `dropped`, `creationDate`) VALUES
	(2, 'ply-1', 'mobilephone', 100, '{}', 2, 0, 1625251071670),
	(3, 'ply-1', 'radio', 100, '{}', 3, 0, 1625251071671),
	(4, 'ply-1', 'water', 100, '{}', 5, 0, 1625251071675),
	(5, 'ply-1', 'water', 100, '{}', 5, 0, 1625251071675),
	(6, 'ply-1', 'sandwich', 100, '{}', 1, 0, 1625251071676),
	(7, 'ply-1', 'sandwich', 100, '{}', 1, 0, 1625251071676),
	(8, 'ply-1', 'idcard', 100, '{"identifier":"1","Name":"Toon","Surname":"Toon","Sex":0,"DOB":"1995-10-31"}', 4, 0, 1625251071673);
...
-- Dumping data for table npcore.user_licenses: ~4 rows (approximately)
/*!40000 ALTER TABLE `user_licenses` DISABLE KEYS */;
REPLACE INTO `user_licenses` (`owner`, `type`, `status`) VALUES
	('1', 'Firearm', 0),
	('1', 'Driver', 1),
	('1', 'Hunting', 0),
	('1', 'Fishing', 0);
...
REPLACE INTO `vehicle_display` (`id`, `model`, `name`, `commission`, `baseprice`, `price`) VALUES
...
DROP TABLE IF EXISTS `__banking_logs`;
